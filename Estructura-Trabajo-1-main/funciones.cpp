...
/*
	Nombre de la función: archivoPerruno
	Tipo de función: void
	Parámetros: nada?
	Dato de retorno: nada
	Descripción de la función: crea el archivo de perros
*/
...
FILE * archivo = fopen("perros001.bin", "wb");

/*
if(archivo != NULL){
    printf("\nAdemás, el archivo de perros ha sido creado exitosamente\n");
    fclose(archivo);
}
else{
    printf("El archivo de perros no ha sido creado, revise el código");
}
*/

/*
perros p;
fread(&p, sizeof(perros), 1, archivo);
fclose(archivo);
